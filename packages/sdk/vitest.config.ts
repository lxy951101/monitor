...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@monitor/plugin-perf-cache": new URL("../plugin-perf-cache/src/index.ts", import.meta.url)
        .pathname,
      "@monitor/plugin-perf-fsp": new URL("../plugin-perf-fsp/src/index.ts", import.meta.url)
        .pathname,
      "@monitor/plugin-perf-ird": new URL("../plugin-perf-ird/src/index.ts", import.meta.url)
        .pathname,
      "@monitor/plugin-perf-shr": new URL("../plugin-perf-shr/src/index.ts", import.meta.url)
        .pathname,
      "@monitor/plugin-pv": new URL("../plugin-pv/src/index.ts", import.meta.url).pathname,
      "@monitor/plugin-resource": new URL("../plugin-resource/src/index.ts", import.meta.url)
        .pathname,
