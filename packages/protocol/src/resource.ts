...
/**
 * 对齐 owl.js BatchMessage protobuf 编码。
 * 非 devMode 时 owl.js 使用 protobuf 二进制格式发送到 resource_pbbatch 端点。
 */
...
/**
 * 编码单条 BatchInfo，对齐 owl.js BatchInfo.encode。
 * 字段顺序和 tag 值完全对齐 owl.js 的 batchInfoStringKeys + batchInfoOptionKeys + lenArr。
 */
...
// ─── 最小化 Protobuf Writer (仅实现 owl.js 用到的 uint32 + string + fork/ldelim) ───
...
/** 图片资源识别正则 (对齐 owl.js imgPattern，增加 tiff 和 query string 支持) */
