...
export interface ResourcePluginOptions extends Omit<
  Partial<ResourceManagerOptions>,
  "send" | "cfgManager"
> {
  ...
  return {
    ...
    start(context: MonitorContext) {
      ...
      const observerOptions = {
        ...
        // 动态回退模式下，每次 AJAX 完成触发 1500ms 轮询
...
function toResourceCall(call: AjaxCall | FetchCall): ResourceCallInput {
  return {
    ...
    statusCode:
      typeof call.statusCode === "string" ? parseInt(call.statusCode, 10) || 0 : call.statusCode,
