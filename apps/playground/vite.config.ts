...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@monitor/plugin-horn": new URL("../../packages/plugin-horn/src/index.ts", import.meta.url).pathname,
      "@monitor/plugin-logan": new URL("../../packages/plugin-logan/src/index.ts", import.meta.url).pathname,
      ...
      "@monitor/plugin-perf-fsp2": new URL("../../packages/plugin-perf-fsp2/src/index.ts", import.meta.url).pathname,
